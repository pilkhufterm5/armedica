...
//end if stock search results to show
	...
	if ($_POST['Quotations']=='Orders_Only'){
		$tableheader = "<TR>
				...
				<TD class='tableheader'>" . _('Nota de Cargo') . "</TD>
	...
	while ($myrow=DB_fetch_array($SalesOrdersResult)) {
		...
		$Confirm_Invoice = $rootpath . '/rh_ConfirmDispatch_Invoice_NC.php?' . SID . '&OrderNumber=' .$myrow['orderno'];
		...
		if ($_POST['Quotations']=='Orders_Only'){
			printf("<td><A HREF='%s'>%s</A></td>
				<td><A HREF='%s'>" . _('Nota de Cargo') . "</A></td>
