...
If ((isset($_POST['PrintPDF'])||isset($_REQUEST['Excel']))
	...
	if ($_POST['Location']=='All'){
		$SQL = "SELECT stockmaster.categoryid,
			...
			AND stockmaster.materialcost + stockmaster.labourcost + stockmaster.overheadcost = 0
...
/*Print out the grand totals */
	...
	$len = strlen($pdfcode);
      ...
      if ($len<=20){
		...
		if(isset($_REQUEST['Excel']))
			header('Content-Disposition: inline; filename=CostoCero.csv');
			else
