...
/*Now insert the sales order too */
		...
		foreach ($_SESSION['SPL']->LineItems as $StockItem) {
			...
			$LineItemsSQL = $StartOf_LineItemsSQL . ", '" . $StockItem->PartCode . "',". $StockItem->Price . ", " . $StockItem->Quantity . ", " . $StockItem->LineNo . ", '" . $SPLLine->ItemDescription . "')";
