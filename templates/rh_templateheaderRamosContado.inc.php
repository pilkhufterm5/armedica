...
if($PrintPDF=='Imprimir PDF (imagen)' && $rh_tipo!=20001){
	...
	if ($rh_tipo!=20001){
		...
		$pdf->addTextWrap(481.5,507+16,72,12,$extInvoice.$ExtRes['extinvoice'], 'right');
	}
}
	//color normal
...
if ($rh_tipo==10)
{
	...
	//fecha expedicion
	$pdf->addTextWrap(473,479.5-5-18+16,30,$rh_fontsize,$myrow['dd'], 'right');
	$pdf->addTextWrap(509,479.5-5-18+16,30,$rh_fontsize,$myrow['mm'], 'right');
	$pdf->addTextWrap(545,479.5-5-18+16,33,$rh_fontsize,$myrow['yy'], 'right');

	//lugar expedicion
	$pdf->addTextWrap(460,425+16,108,9,'Ramos Arizpe', 'right');
	...
	//cliente
	$pdf->addTextWrap(95,469-20-5-10-18+16,360,$rh_fontsize-1,$myrow['name'].' '.$myrow['name2'], 'left');
	...
	if (strlen($rh_unirDir) > 50)
	{
		...
		//direccion
		$pdf->addTextWrap(95,457-29-5-10-18+16,360,$rh_fontsize-1.5,$rh_strtmpI, 'left');//linea 1
		$pdf->addTextWrap(95,449-37-5-10-18+16,360,$rh_fontsize-1.5,$rh_strtmpF, 'left');//linea 2
		$pdf->addTextWrap(95,442-38-5-10-18+16,360,$rh_fontsize-1.5,$myrow['address4'].' '.$myrow['address5'].' C.P. '.$myrow['address6'], 'left');//linea 3
	}
	else
	{
		//direccion
		$pdf->addTextWrap(95,455-29-5-10-18+16,360,$rh_fontsize-1,$rh_unirDir, 'left');//linea 1
		$pdf->addTextWrap(95,444-38-5-10-18+16,360,$rh_fontsize-1,$myrow['address4'].' '.$myrow['address5'].' C.P. '.$myrow['address6'], 'left');//linea 2
	}
	...
	//rfc
	$pdf->addTextWrap(360,444-38-5-10-18+16,144,$rh_fontsize-1,$myrow['taxref'], 'left');
