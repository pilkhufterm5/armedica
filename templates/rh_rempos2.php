	...
	// obtener el numero de transaccion de la remision pedida
	   ...
	   if (DB_num_rows($result)==1){
		...
		if (DB_num_rows($result)>0){
			...
			include('rh_remposheader2.inc.php');
			$FirstPage = False;
			//$pdf->SetTextColor(255,0,0);
				...
				$LeftOvers = $pdf->addTextWrap($XPos,$YPos,50,$FontSize,$DisplayQty,'left');
				$LeftOvers = $pdf->addTextWrap($XPos+26,$YPos,70,$FontSizeCode,$myrow2['stockid'],'left');
				$LeftOvers = $pdf->addTextWrap($XPos+100,$YPos,250,$FontSize,$myrow2['description'],'left');
				$LeftOvers = $pdf->addTextWrap($XPos+410,$YPos,50,$FontSize,$DisplayPrice,'right');
				$LeftOvers = $pdf->addTextWrap(530,$YPos,50,$FontSize,$DisplayNet,'right');
		...
		//$LeftOvers = $pdf->addTextWrap(540,40,50,$FontSize,$DisplaySubTot, 'right');
		...
		$LeftOvers = $pdf->addTextWrap(376,15,50,$FontSize,$DisplaySubTot, 'right');
		//$pdf->addText($Page_Width-$Right_Margin-220, $YPos-(2*$line_height)+5,$FontSize, _('Tax'));
		$LeftOvers = $pdf->addTextWrap(456,15,50, $FontSize,$DisplayTax, 'right');
		//530
		$LeftOvers = $pdf->addTextWrap(526,15,50, $FontSize,$DisplayTotal, 'right');
		/*rule off for total */
