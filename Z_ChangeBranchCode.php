...
/*First check the customer code exists */
	...
	if (strstr($_POST['NewBranchCode'],".")>0 OR  strstr($_POST['NewBranchCode'],"&") 
		OR (!strstr(' '.$_POST['NewBranchCode'],"T-")&&strstr($_POST['NewBranchCode'],"-")) 
		OR strstr($_POST['NewBranchCode']," ")){
