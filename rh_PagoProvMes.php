...
if (!isset($_POST['Show'])){
$title = _('Pago Proveedores al Mes');
...
echo '<CENTER><TABLE>
		<TR>
		<TD COLSPAN=2 ALIGN=CENTER><B>'._('Pago Proveedores al Mes').'</TD>
		</TR>';	
echo '<TR>
         <TD>'._('From').':</TD>
...
/*Yes there are line items to start the ball rolling with a page header */
	...
	$PageNumber = 1;
	include('includes/rh_PagoProvMesHeader.inc');
	$FontSize = 9;
...
if ($len<=20){
	...
	header('Content-Disposition: inline; filename=PagoProvMes.pdf');
	header('Expires: 0');
