...
/**
 * REALHOST 2008
 * $LastChangedDate: 2008-02-07 13:29:23 -0600 (Thu, 07 Feb 2008) $
 * $Rev: 25 $
 */
...
if (isset($_POST['submit'])) {
	...
	// bowikaxu realhost Feb 2008 - enable to update groupname
...
// bowikaxu - show and hide
$initialgroup = '';
echo "<span id='test' style='display:none'>";

	$k=0; //row colour counter
	while ($myrow = DB_fetch_row($result)) {

		// bowikaxu
		if($initialgroup!=$myrow[1]){
			//echo "</div><div id='".$myrow[1]."'>";
			echo '</span><span id="'.$myrow[1].'" style="display:none">';
			//echo '<TD><A HREF="javascript:showHide(\''.$myrow[1].'\')">'. _('Hide') .'</A></TD>';
			$initialgroup = $myrow[1];
