...
$title = _('Cat&aacute;logo de especies');
include('includes/header.inc');

echo "<CENTER><H1>"._('Especie')."</H1></CENTER>";
?>
<script type="text/javascript" src="rh_java/rh_especie.js"></script>
<?

$sqlcount = 'SELECT COUNT(id) AS paginas FROM rh_especie';
...
$sql = 'SELECT * FROM rh_especie ORDER BY codigo ASC LIMIT 0,20';
