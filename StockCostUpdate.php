...
if ($myrow['mbflag']=='D' 
	OR $myrow['mbflag']=='A' 
	OR $myrow['mbflag']=='E' // bowikaxu realhost 15 july 2008 - ensamblado costo por componente 
	OR $myrow['mbflag']=='K'){
   ...
   } else if ($myrow['mbflag']=='E'){ // bowikaxu realhost 15 july 2008 - ensamblado costo por componente 
        echo "<BR>$StockID " . _('is a ').' '._('Assembly') . ' '._('Costo por Coponente');
   } else if ($myrow['mbflag']=='K'){
        echo "<BR>$StockID " . _('is a kit set part');
   }else if ($myrow['mbflag']=='C'){
   		// bowikaxu realhost Feb 2008 - lets change the item cost
        echo "<BR>$StockID " . _('is a ').' '._('Manufactured').' '._('Costo por Componente');
   }
...
if (! in_array($UpdateSecurity,$_SESSION['AllowedPageSecurityTokens']) OR !isset($UpdateSecurity)){
	...
	if ($myrow['mbflag']!='M' AND $myrow['mbflag']!='C') { // bowikaxu realhost Feb 2008
	...
	if ($myrow['mbflag']=='M' OR $myrow['mbflag']=='C'){ // bowikaxu realhost Feb 2008
