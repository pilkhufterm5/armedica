...
/* Also reads all the company data set up in the company record and returns an array */
	// bowikaxu - obtencion del rh_InvoiceShipmentact
	// bowikaxu realhost - FEB 2008 - get advanced creditors/debtors account
	
	//agregar la siguiente instruccion:  alter table companies add site varchar(200)
	$sql=	"SELECT
			coyname,
			gstno,
			regoffice1,
