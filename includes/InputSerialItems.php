...
echo '<FORM METHOD="POST" ACTION="' . $_SERVER['PHP_SELF'] . '?' . $term . '" enctype="multipart/form-data" >';
...
$EditLink =  '<br><A HREF="' . $_SERVER['PHP_SELF'] . '?' . $term . '&EditControlled=true'.
	'&LineNo=' . $LineNo .'">'. _('Edit'). '</a> | ';
$RemoveLink = '<A HREF="' . $_SERVER['PHP_SELF'] . '?' . $term . '&DELETEALL=YES'.
