<?php
/**
 Autor de código: 				--	Eliobeth Ruiz Hernández	--
 Dueño legal de la aplicación: 	--	AR Medica --
...
<script>
	...
	<?php
	echo "<A HREF='rh_DunningLetter_Torreon.php'>"._('Go Back')."</A>";
...
table;
	...
	$SQL = "SELECT debtorsmaster.debtorno,
				...
				WHERE debtorsmaster.paymentterms = paymentterms.termsindicator
					...
					$SalesLimit
					AND debtorsmaster.debtorno = rh_cobranza.debtorno
					AND (rh_cobranza.metodo_pago = 'TARJETA DE DEBITO' or rh_cobranza.metodo_pago = 'TARJETA DE CREDITO')
				GROUP BY debtorsmaster.debtorno,
					debtorsmaster.name,
					currencies.currency,
					paymentterms.terms,
...
//AKI
		echo "	<TD>".$AgedAnalysis['AfilNo']."</TD>
                ...
                <TD>".$prDate['max']."</TD>
                <td><a href='{$rootpath}/modulos/index.php?r=afiliaciones/RecordatoriopagoTorreonpdf&Folio={$AgedAnalysis['AfilNo']}' target='_blank' > "._('Print')." </a></td>
                <!-- <TD ALIGN=center><A HREF='rh_DunningLetter_Torreon.php?DebtorNo=".$AgedAnalysis['debtorno']."'>"._('Print')."</A></TD> -->
				".
				"<TD ALIGN=center>
	...
	echo "<CENTER><H2><STRONG>"._('Cartas de Adeudo Solo Pago con Tarjeta')."</STRONG></H2></CENTER><BR>";
