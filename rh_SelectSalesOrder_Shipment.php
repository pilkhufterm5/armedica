...
if (!isset($StockID)) {
	...
	if ($_REQUEST['OrderNumber']=='' OR !$_REQUEST['OrderNumber']){
		...
		$sql = 'SELECT loccode, locationname FROM locations UNION SELECT loccode, locationname FROM rh_locations_virtual';
...
//end if stock search results to show
	...
	if ($_POST['Quotations']=='Orders_Only'){
		$tableheader = "<TR>
				...
				<TD class='tableheader'>" . _('Remisionar') . "</TD>
	...
	while ($myrow=DB_fetch_array($SalesOrdersResult)) {
		...
		$Confirm_Invoice = $rootpath . '/rh_ConfirmDispatch_Shipment.php?' . SID . '&OrderNumber=' .$myrow['orderno'];
