...
$title = _('Cat&aacute;logo Marca');
include('includes/header.inc');

echo "<CENTER><H1>"._('Marca')."</H1></CENTER>";
?>
<script type="text/javascript" src="rh_java/rh_marca.js"></script>
<?

$sqlcount = 'SELECT COUNT(id) AS paginas FROM rh_marca';
...
$sql = 'SELECT * FROM rh_marca ORDER BY codigo ASC LIMIT 0,20';
...
<TR>
<TD>"._('Code').":</TD>
<TD><INPUT TYPE='text' SIZE=12 MAXLENGTH=10 NAME='codigo'></TD>
</TR>
<TR>
<TD>"._('Name').":</TD>
