...
if (isset($_POST['UpdateReq']) && isset($_GET['reqno'])){
    ...
    if (isset($_GET['reqno'])){
    header('Location:' . $rootpath . '/REQ_Items.php?reqno=' . SID . $_GET['reqno']);
    exit;
    }
}
...
if (isset($_POST['SaveReq'])){
    ...
    if (isset($TransNo)){
    header('Location:' . $rootpath . '/REQ_Header.php?reqno=' . SID . $TransNo);
    exit;
    }
}
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="container-fluid no-outter-border" style="max-width: 50%; margin-left: 25%;">
                ...
                <?php if(isset($_GET['reqno'])){ ?>
                <a href="<?php echo $rootpath.'/REQ_Items.php?reqno=' . SID . $_GET['reqno']; ?>" ><input type="button" id="AddItems" name="AddItems" value="Agregar Articulos"  /></a>
                <?php } ?>
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner">
                                <p>
                                    <?php include("REQ_Items.php?reqno=" . SID . $_GET['reqno']); ?>
                                </p>
                            </div>
                        </div>
                    </div>
