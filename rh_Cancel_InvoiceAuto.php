...
echo "<FORM ACTION='" . $_SERVER['PHP_SELF'] . "?" . SID . "' METHOD=POST NAME='formulario' ID='CANCELARFACT'>";
...
=============================== */
if(!isset($_SESSION['FacturacionAutomatica'])) {
	echo "
	<script>
...
/*if the credit note is a return of goods then need to know which location to receive them into */
		...
		echo '<TR><TD>' . _('Accept Cancel Terms') . '</TD><TD><SELECT NAME=AcceptTerms >';
	...
	echo "<INPUT TYPE=SUBMIT NAME='ProcessCredit' ID='ProcessCredit' ENABLE Value='" . _('Procesar Cancelacion') ."'></CENTER>";
	//echo "<INPUT TYPE=SUBMIT NAME='Continue' ENABLE Value='" . _('Procesar Cancelacion') ."'></CENTER>";
