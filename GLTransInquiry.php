 ...
 * change the view of gl transactions
 *
 */
...
/**************************************************************************
* Jorge Garcia
* 04/Nov/2008 Enlace para subir archivo
***************************************************************************/
echo "<CENTER><a href=rh_upload.php?".SID."&type=".$_GET['TypeID']."&typeno=".$_GET['TransNo'].">"._('File Upload')."</a>";
/**************************************************************************
* Jorge Garcia Fin Modificacion
***************************************************************************/

// bowikaxu realhost March 2008 - ver archivos relacionados.
$sql = "SELECT * FROM rh_files WHERE type = ".$_GET['TypeID']." AND transno = ".$_GET['TransNo']."";
$res = DB_query($sql,$db);
if(DB_num_rows($res)){
	...
	echo "<BR><BR><TABLE ALIGN=CENTER>
		<TR><TD COLSPAN=6 ALIGN=CENTER><B><BIG>"._('Related Files')."<BIG></B></TD></TR>
		<TR>
	...
	while($finfo = DB_fetch_array($res)){
...
// bowikaxu realhost March 2008 - fin ver archivos relacionados.
