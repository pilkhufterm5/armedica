...
if (isset($_POST['PrintPDF'])){
	...
	While ($Customers = DB_fetch_array($CustomersResult,$db)){
		...
		if ($PrintThisCustomer){
			...
			$LeftOvers = $pdf->addTextWrap(80,$YPos-40,150,$FontSize,$Customers['address4']);
			$LeftOvers = $pdf->addTextWrap(80,$YPos-50,150,$FontSize,$Customers['address5']);
			$LeftOvers = $pdf->addTextWrap(80,$YPos-60,150,$FontSize,$Customers['address6']);
			...
			$LeftOvers = $pdf->addTextWrap(440,$YPos-30,150,$FontSize,$Customers['braddress4']);
			$LeftOvers = $pdf->addTextWrap(440,$YPos-40,150,$FontSize,$Customers['braddress5']);
			$LeftOvers = $pdf->addTextWrap(440,$YPos-50,150,$FontSize,$Customers['braddress6']);
			$LeftOvers = $pdf->addTextWrap(440,$YPos-60,150,$FontSize,$Customers['email']);

			$pdf->line($Page_Width-$Right_Margin, $YPos-62,$Left_Margin, $YPos-62);
