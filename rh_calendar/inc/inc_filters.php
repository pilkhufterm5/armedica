...
/*
	...
	$Id: inc_filters.php,v 1.76.2.11 2006/01/23 18:54:21 mlutfy Exp $
*/
...
function format_date2($timestamp = '', $format = 'full') {
...
function format_time($timestamp = '', $format = 'short') {
	return format_date2($timestamp, 'time_' . $format);
}
...
function get_person_name($item) {
	...
	return njoin(array($item['realname']));
}
