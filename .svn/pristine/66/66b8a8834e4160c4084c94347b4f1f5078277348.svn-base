...
//end if stock search results to show
	...
	if (isset($_REQUEST['OrderNumber']) && $_REQUEST['OrderNumber'] !='') {
			...
			$SQL = "SELECT salesorders.orderno,
				...
				AND salesorders.quotation =" .$Quotations . "
                                and rh_carta_porte.id_salesorders = salesorders.orderno
	...
	if ($_POST['Quotations']=='Orders_Only'){
		$tableheader = "<TR>
				...
				<TD class='tableheader'>" . _('Carta Porte') . "</TD>
	...
	while ($myrow=DB_fetch_array($SalesOrdersResult)) {
		...
		$ModifyPage = $rootpath . "/SelectOrderItems.php?" . SID . '&ModifyOrderNumber=' . $myrow['orderno'].'&isCartaPorte=true';
		$Confirm_Invoice = $rootpath . '/rh_cartaPorte_ConfirmDispatch_Invoice.php?' . SID . '&OrderNumber=' .$myrow['orderno'];
