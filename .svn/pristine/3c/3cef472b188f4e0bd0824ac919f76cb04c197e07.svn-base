 ...
 */
class Cobrador extends CActiveRecord {
    /**
    ...
    public function rules() {
        ...
        return array(
            //array(
            //    'nombre, comision, zona, activo, reasigna, transfe, cobori, empresa',
            //    'required'
            //),
            array(
                'activo, reasigna, transfe, cobori, empresa',
                'numerical',
                'integerOnly' => true
            ),
            array(
            ...
            array(
                'id, nombre, comision, zona, activo, reasigna, transfe, cobori, empresa',
                'safe',
                'on' => 'search'
            ),
        );
     ...
     * @return Cobrador the static model class
     */
