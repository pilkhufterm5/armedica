...
// bowikaxu realhost - april 2008 - dividir cantidad en debito y credito
if(isset($_POST['GLAmountDebit']) && $_POST['GLAmountDebit']>0){

	$_POST['GLAmount'] = $_POST['GLAmountDebit'];
	unset($_POST['GLAmountDebit']);

}
if(isset($_POST['GLAmountCredit']) && $_POST['GLAmountCredit']>0){

	$_POST['GLAmount'] = (-1*$_POST['GLAmountCredit']);
	unset($_POST['GLAmountCredit']);
...
// bowikaxu realhost - april 2008 - dividir la cantidad en debito y credito
echo '<TR>
		<TD>'._('Debit').":</TD><TD><INPUT TYPE=Text Name='GLAmountDebit' Maxlength=12 SIZE=12 VALUE=" . $_POST['GLAmountDebit'] . '></TD>
	</TR>
	<TR>
		<TD>'._('Credit').":</TD><TD><INPUT TYPE=Text Name='GLAmountCredit' Maxlength=12 SIZE=12 VALUE=" . $_POST['GLAmountCredit'] . '></TD>
	</TR>';
