...
class Oportunidad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('debtorno, branchcode, lead_id, folio, nombre, apellido, initial_contact, estatus, ocupacion, calle, colonia, entrecalles, municipio, cp, telefono, telefono2, fax, email, referidopor, nombre_empresa, razon_social, clasificacion, nempleados, turnos, medico_planta, visitantes, tiempo_permanencia, dias_publico, plan_cotizado, socios, forma_pago, frecuencia_pago, convenio_empresa, inscripcion_pmes, segundo_mes', 'required'),
			array('lead_id, initial_contact, cp, nempleados, socios', 'numerical', 'integerOnly'=>true),
			...
			array('telefono, telefono2, fax', 'length', 'max'=>15),
			array('email', 'length', 'max'=>50),
			array('inscripcion_pmes, segundo_mes', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, debtorno, branchcode, lead_id, folio, nombre, apellido, initial_contact, estatus, ocupacion, calle, colonia, entrecalles, municipio, cp, telefono, telefono2, fax, email, referidopor, nombre_empresa, razon_social, clasificacion, nempleados, turnos, medico_planta, visitantes, tiempo_permanencia, dias_publico, plan_cotizado, socios, forma_pago, frecuencia_pago, convenio_empresa, inscripcion_pmes, segundo_mes', 'safe', 'on'=>'search'),
		);
	}
