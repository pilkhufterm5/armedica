...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "No hay información" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Mostrado(s) _START_ a _END_ de _TOTAL_ resultado(s)",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtraddo de _MAX_ total registros)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "No se encontraron datos que conicidan"
		},
