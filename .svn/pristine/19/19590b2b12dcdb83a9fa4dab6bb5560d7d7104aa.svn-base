...
/**
 * @version $Id: init.php 115 2009-01-10 11:18:58Z soeren $
 * @package eXtplorer
...
//$fold = '/var/www/erp_clinicas/companies/'.$_GET['base'].'/pacientes/'.md5($_GET['debtorno']).'/archivos/';

//$var_p = "/var/www/erp_clinicas/companies/clinicas_test_001/pacientes/d41d8cd98f00b204e9800998ecf8427e/archivos/";

//$_REQUEST['dir'] = (string)$fold;//ltrim(rtrim(trim($folderrs))); //--> se obtiene por SESSION
