...
$rh_fontsize=$rh_fontsize+2;
		...
		if ($rh_tipo==10)
		{
			...
			$pdf->y = $Page_Height - 129 - 30 - 32 - 12;
			$pdf->x = 30;
			$pdf->SetFontSize($rh_fontsize-3);
			$pdf->MultiCell(432,$line_height,strtoupper($ConLetra),0,'J',0,15);

			//subtotal
			$pdf->addTextWrap(504-8,97-51+60+40+10+11,81,$rh_fontsize+1,$DisplaySubTot, 'right');
	/*
			//iva %
	...
	*/
			//iva
			$pdf->addTextWrap(504-8,75-51+60+40+10+11,81,$rh_fontsize+1,$DisplayTax, 'right');

			//total
			$pdf->addTextWrap(504-8,51-51+60+40+10+11,81,$rh_fontsize+1,$DisplayTotal, 'right');
		}
		else
		{
			//total letra
