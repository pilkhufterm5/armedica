...
// bowikaxu realhost august 07 - add the chequeno insert
  ...
  /*Set up a newy in case user wishes to enter another */
	...
	//echo "<META HTTP-EQUIV='REFRESH' CONTENT='0;URL=" . $rootpath . "/SupplierAllocations.php?" . SID ."&AllocTrans=".$BMove."'>";
	//include('SupplierAllocations.php');
...
echo '<TR><TD>' . _('Ref') . ':</TD><TD><INPUT TYPE="text" name="Narrative" maxlength=249 size=60 value="' . $_POST['Narrative'] . '"></TD></TR>';
echo '</TABLE>';
