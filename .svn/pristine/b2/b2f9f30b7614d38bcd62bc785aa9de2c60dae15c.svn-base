...
$title = _('Cat&aacute;logo de Rutas');
include('includes/header.inc');

echo "<CENTER><H1>"._('Rutas')."</H1></CENTER>";
?>
<script type="text/javascript" src="rh_java/rh_rutas.js"></script>
<?

$sqlcount = 'SELECT COUNT(id) AS paginas FROM rh_rutas';
...
$sql = 'SELECT * FROM rh_rutas ORDER BY codigo ASC LIMIT 0,20';
