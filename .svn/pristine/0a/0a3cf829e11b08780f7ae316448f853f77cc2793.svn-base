...
class PhpWsdl{
	...
	public function OutputHtml($withHeaders=true,$echo=true,$cache=true){
		...
		// Footer
		$res[]='<hr>';
		$res[]='<p><small>Powered by <a href="http://code.google.com/p/php-wsdl-creator/">PhpWsdl</a><span style="display:none" class="noprint"> - PDF download: <a href="'.$pdfLink.'">Download this page as PDF</a></span></small></p>';
		$res[]='</body>';
		$res[]='</html>';
