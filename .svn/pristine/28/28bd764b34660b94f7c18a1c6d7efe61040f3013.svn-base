...
if (isset($TransferItem)){
	...
	echo '<br><a href="'.$rootpath.'/StockLocTransferReceive.php?'  . $term . '">'._('Back To Transfer Screen').'</A>';
} else {
	echo '<br><a href="'.$rootpath.'/StockTransfers.php?'  . $term . '">'._('Back To Transfer Screen').'</A>';
}
