...
while ($myrow=DB_fetch_array($TransResult)) {
	...
	// Septiembre 2006
	// realhost
	// bowikaxu - se modifico el tipo de 10 a 20000

	if (in_array(3,$_SESSION['AllowedPageSecurityTokens']) && ($myrow['type']==20000)){ /*Show a link to allow a remision to be credited */
...
// bowikaxu se modifico el tipo de 10 a 20000
	} elseif($myrow['type']==20000) { /*its an invoice but not high enough priveliges to credit it */
