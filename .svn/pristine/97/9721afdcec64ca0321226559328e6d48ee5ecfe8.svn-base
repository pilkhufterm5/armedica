...
/*
	...
	$Id: inc_version.php,v 1.81.2.38 2006/11/10 15:09:01 mlutfy Exp $
*/

require_once("inc_keywords.php");
...
function _Tkw($grp, $val, $args = '') {
	...
	if (count($kwg)) {
		...
		else {/*Realhost Alberto 25/Agosto/07
