...
function show_header($dirlinks='') {
	...
	echo "<link rel=\"stylesheet\" href=\""._EXT_URL."/style/style.css\" type=\"text/css\" />\n";
        echo "<style>.x-layout-panel-north{display:none !important;}</style>";
	...
	//echo "</div>";
	echo "<td style=\"padding-left: 15px; color:black; display:none!important;\" id=\"bookmark_container\" width=\"35%\"></td>\n";
	echo "<td width=\"25%\" style=\"padding-left: 15px; color:black; display:none!important;\">".sprintf( $GLOBALS['messages']['switch_file_mode'], $mode . $logoutlink, "<a id=\"switch_file_mode\" href=\"$url".$url_appendix."file_mode=$alternate_mode\">$alternate_mode</a>" ). "
	</td>\n";
