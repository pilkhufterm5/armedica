...
echo '<TR><TD>' . _('Show') . ' ' . $TypeName . ' ' . _('before') . ':</TD>
	<TD><INPUT tabindex="2" TYPE=TEXT NAME="BeforeDate" class="date" alt="'.$_SESSION['DefaultDateFormat'].'" SIZE=12 MAXLENGTH=10 Value="' . $_POST['BeforeDate'] . '"></TD>';
echo '<TD>' . _('but after') . ':</TD>
	<TD><INPUT tabindex="3" TYPE=TEXT NAME="AfterDate" class="date" alt="'.$_SESSION['DefaultDateFormat'].'" SIZE=12 MAXLENGTH=10 Value="' . $_POST['AfterDate'] . '"></TD></TR>';
