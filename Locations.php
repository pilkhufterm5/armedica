...
include('includes/header.inc');
		$_POST['MaxItmInv'] = 9999;
		$_POST['MaxItmRem'] = 9999;
		$_POST['MaxItmPos'] = 9999;
		$_POST['MaxItmNtc'] = 9999;
...
if (isset($_POST['submit'])) {
	...
	if (isset($SelectedLocation) AND $InputError !=1) {
		...
		if($_POST['Managed'] == 'on'){
            ...
            if((DB_num_rows($res)>0 || DB_num_rows($resNotaCre)>0 || $errorSerie)&&(false)){
                    ...
                    $sql = "UPDATE locations SET $facExt $ncExt
                                    ...
                                    deladd7='" . $_POST['DelAdd7'] . "',
                                    deladd8='" . $_POST['DelAdd8'] . "',
                                    deladd9='" . $_POST['DelAdd9'] . "',
                                    deladd10='" . $_POST['DelAdd10'] . "',
                                    tel='" . $_POST['Tel'] . "',
                                    fax='" . $_POST['Fax'] . "',
                                    email='" . $_POST['Email'] . "',
...
if (!isset($_GET['delete'])) {
	...
	if ($SelectedLocation) {
		...
		$_POST['DelAdd6'] = $myrow['deladd6'];
                $_POST['DelAdd7'] = $myrow['deladd7'];
                $_POST['DelAdd8'] = $myrow['deladd8'];
                $_POST['DelAdd9'] = $myrow['deladd9'];
                $_POST['DelAdd10'] = $myrow['deladd10'];
	...
	// bowikaxu - already set the initial external invoice or set it up?
		...
		*/
		...
		// bowikaxy april 2007 - serie de las facturas
			...
			//echo "<INPUT TYPE=hidden name='InvSerie' value='".$_POST['InvSerie']."' SIZE=5 MAXLENGTH=5></TD></TR>";
            echo "<INPUT TYPE=hidden name='InvSerie' value='0' SIZE=5 MAXLENGTH=5></TD></TR>";
            
			// bowikaxy june 2007 - template de facturas
			//echo "<TR><TD>"._('Invoice Template').":</TD><TD>";
			//echo "<INPUT TYPE=hidden name='InvTemplate' value='".$_POST['InvTemplate']."' SIZE=5 MAXLENGTH=5></TD></TR>";
            echo "<INPUT TYPE=hidden name='InvTemplate' value='' SIZE=5 MAXLENGTH=5></TD></TR>";
            
			// bowikaxy june 2007 - numero maximo de articulos en factura
			//echo "<TR><TD>"._('Articulos Maximos').":</TD><TD>";
			//echo _('Invoice').":<INPUT TYPE=text name='MaxItmInv' value='".$_POST['MaxItmInv']."' SIZE=5 MAXLENGTH=5>";
			//echo ' '._('Remision').":<INPUT TYPE=text name='MaxItmRem' value='".$_POST['MaxItmRem']."' SIZE=5 MAXLENGTH=5>";
	...
	<TR><TD><?php echo _('Address Line 1') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd1" value="<?php echo $_POST['DelAdd1']; ?>" SIZE=41 MAXLENGTH=40></TD></TR>
	<TR><TD><?php echo _('Address Line 2') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd2" value="<?php echo $_POST['DelAdd2']; ?>" SIZE=41 MAXLENGTH=40></TD></TR>
	<TR><TD><?php echo _('Address Line 3') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd3" value="<?php echo $_POST['DelAdd3']; ?>" SIZE=41 MAXLENGTH=40></TD></TR>
	<TR><TD><?php echo _('Address Line 4') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd4" value="<?php echo $_POST['DelAdd4']; ?>" SIZE=41 MAXLENGTH=40></TD></TR>
	<TR><TD><?php echo _('Address Line 5') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd5" value="<?php echo $_POST['DelAdd5']; ?>" SIZE=21 MAXLENGTH=20></TD></TR>
	<TR><TD><?php echo _('Address Line 6') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd6" value="<?php echo $_POST['DelAdd6']; ?>" SIZE=16 MAXLENGTH=15></TD></TR>
        <TR><TD><?php echo _('Address Line 7') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd7" value="<?php echo $_POST['DelAdd7']; ?>" SIZE=16 MAXLENGTH=15></TD></TR>
        <TR><TD><?php echo _('Address Line 8') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd8" value="<?php echo $_POST['DelAdd8']; ?>" SIZE=16 MAXLENGTH=15></TD></TR>
        <TR><TD><?php echo _('Address Line 9') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd9" value="<?php echo $_POST['DelAdd9']; ?>" SIZE=16 MAXLENGTH=15></TD></TR>
        <TR><TD><?php echo _('Address Line 10') . ':'; ?></TD>
	<TD><input type="Text" name="DelAdd10" value="<?php echo $_POST['DelAdd10']; ?>" SIZE=16 MAXLENGTH=15></TD></TR>
