...
//end of while loop
	...
	echo "<input type='submit' name ='facturar' value='Crear Factura'></input></form>";
...
//					$Result = DB_query($SQL,$db,$ErrMsg,$DbgMsg,true);
			...
			if ($MBFlag=='B' OR $MBFlag=='M'){
					...
					VALUES ('" . $OrderLine->StockID . "',
						...
						//iJPe - Se cambio la cantidad ya que mas abajo la cantidad que se disminuye es la que regresa
                                                //al mandar a ceros los movimientos de inventario de la remision
