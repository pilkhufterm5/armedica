...
<div id="Modal_EditarSimulaciones" class="modal hide fade" role="dialog" aria-
labelledby="myModalLabel" aria-hidden="true" style="width: 40%;" >
...
<div class="span3">
<div class="controls">
<input type="text" id="E-usuario" name="E-usuario" value="<?php echo $_SESSION['UserID'];?>"
readonly="readonly" />
</div>
</div>
</div>
...
<button id="Create-Modal-EditarSimulaciones" class="btn btn-success" data-dismiss="modal" aria-
hidden="true" >Aceptar</button>
</div>
</div>