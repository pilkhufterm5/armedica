<script type="text/javascript">
    ...
    function FacturarTimbrar(){
        ...
        if (confirm('¿Desea Facturar y Timbrar todas los Folios de la busqueda?')) {
            ...
            var jqxhr = $.ajax({
                url: "<?php echo $this->createUrl("facturacion/Facturaemisionmasiva"); ?>",
                type: "POST",
                dataType : "json",
                timeout : (0),
                data: {
...
<div class="container-fluid">
    <form method="POST" action="<?php echo $this->createUrl("facturacion/emisionmasiva/"); ?>" >
        <h3>Emisión Masiva de Empresas con sucursales </h3>
