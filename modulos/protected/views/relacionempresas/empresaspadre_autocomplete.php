    ...
    $(document).on('ready', function() {
        ...
        var availableTags = [
                    ...
                    else
                    {
                        ...
                        {
                            value: <?=$rowEmpresasPadreDisponibles['id']?>,
                            label: "<?=$rowEmpresasPadreDisponibles['folio'].' - '.$NombreEmpresa.' - '.$rowEmpresasPadreDisponibles['taxref'] ?>"
                        },
                     <?php } ?>
                ];
...
<div class="container-fluid">
    ...
    <div class="tab-content"> <!-- Start TABS -->
        ...
        <div id="Create" class="tab-pane fade active">
            ...
            <div class="ui-widget">
              <label for="tags">Seleccione Empresa:  </label>
