            ...
            <div class=" row span12">
                ...
                <div class="span6">
                    ...
                    <div class="controls">
                        ...
                        -->
                        <!--
                        COMENTADO POR DANIEL VILLARREAL EL 31 DE DICIEMBRE DEL 2015, SE CAMBIO POR 53
                        <input id="SMVInicialWeeks" name="SMVInicialWeeks" type="number" value="<?=$_POST['SMVInicialWeeks']?>" max="52" style="width: 60px;" />
                        -->
                         <input id="SMVInicialWeeks" name="SMVInicialWeeks" type="number" value="<?=$_POST['SMVInicialWeeks']?>" max="53" style="width: 60px;" />
