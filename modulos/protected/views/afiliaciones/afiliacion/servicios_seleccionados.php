    ...
    <div class="container-fluid bootspin">
        <div class="control-group row-fluid">
            ...
            if(!empty($ListaServicios['rh_servicios'])){
                ...
                ?>
                    <input type="checkbox" id="<?=$Servicio['namespace']?>"    name="servicios_seleccionados[<?=$Servicio['namespace']?>]"    value="<?=$Servicio['id_servicio']?>"   <?=$CHECK?>      class="SS CheckSelect" /> <?=$Servicio['descripcion']?> &nbsp;&nbsp;&nbsp;
                <?php
                }
            }else{ ?>
