...
$fecha_react = "
SELECT fecha_ingreso as f_r
FROM rh_titular
WHERE debtorno = '$debtorno'";
$fecha_r = Yii::app()->db->createCommand($fecha_react)->queryAll();
        //$__fecha_react['fecha_reactivacion'] = "Fecha lol";
        //echo "<pre>";print_r($__fecha_react);exit();
?>
        ...
        <div class="control-group row-fluid">
            <div class="span4">
                <label class="control-label" for="spin1">
                    <?php echo _('Fecha Ingreso Inicial'); ?><a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Fecha Inicial"><i class="icon-photon info-circle"></i></a>
                </label>
                <div class="controls">
                    <?php
                    ...
                    ?>
                    <input type="text" id="fecha_ingreso" class="required" readonly="readonly" name="fecha_ingreso" style="width: 120px;" value="<?=$_POST['fecha_inicial']?>" />
                </div>
            </div>
<!-- 
AGREGADO PARA SABER LA FECHA DE LA ULTIMA REACTIVACION DEL SOCIO ACTUAL
Autor: Eliobeth Ruiz
...
-->
            ...
            <div class="span4">
                <label class="control-label" for="spin1">
                    <?php echo _('Fecha Ingreso Actual'); ?><a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Fecha de Ingreso"><i class="icon-photon info-circle"></i></a>
                </label>
                <div class="controls">
                    <?php
