...
<div id="Modal_CancelarSocio" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    ...
    <div class="modal-footer">
        ...
        <button id="Send_Modal_CancelarSocio" name="Modal_CancelarSocio" class="btn btn-danger" data-dismiss="modal" onclick="Crecargarpagina()" >Aceptar</button>
    </div>
</div>
