<script type="text/javascript">
    $(document).on('ready',function() {
        ...
        $("#GSSearch").click(function(event) {
            var jqxhr = $.ajax({
                url: "<?php echo $this->createUrl("afiliaciones/BuscarFolioSocio"); ?>",
                type: "POST",
                dataType : "json",
                timeout : (120 * 1000),
                data: {
                    Search:{
                        ...
                        Folio: $("#GSFolio").val(),
                         Empresa: $("#GSEmpresa").val(),// Se agrego para filtrar por empresa Angeles Perez 29-04-2016
                    },
                },
...
<div style="height: 20px;"></div>
  ...
  <div class="container-fluid">
    ...
    <div class="control-group row-fluid">
        <div class="form-legend"><h3>Busqueda de Socios</h3></div>
        ...
        <div class="tab-content"> <!-- Start TABS -->
            <div id="Lista" class="tab-pane fade active in">
                ...
                <div class="control-group row-fluid">
                    ...
                    <div class="span3">
                        <label class="control-label" >Nombre/Apellido:</label>
                        <div class="controls">
                            <input type="text" id="GSNombre" name="Search[GSNombre]" >
                        </div>
                    </div>
                     <!--Se agrego para filtrar por empresa Angeles Perez 29-04-2016 -->
                    <div class="span3">
                        <label class="control-label" >Empresa:</label>
                        <div class="controls">
                            <input type="text" id="GSEmpresa" name="Search[GSEmpresa]" >
                        </div>
                    </div>
                    <!--Termina-->
                    <div class="span3">
                ...
                <table id="ListAfiliados" class="table table-hover table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo _('Empresa') ?></th><!--Se agrego para mostrar el nombre de la empresa Angeles Perez 29-04-2016-->
