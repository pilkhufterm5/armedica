...
<form class="form-horizontal" method="POST" action="<?php echo $this->createUrl("frecuenciapago/updateFrecuencia/"); ?>" >
    <div class="container-fluid">
        ...
        <div class="control-group row-fluid">
            ...
            <div class="span3">
                <div class="controls">
                    <input type="text" value="<?=$FrecuenciaPago['dias']?>"  id="dias" name="dias" />
                </div>
            </div>
        </div>
