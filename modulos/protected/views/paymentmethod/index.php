        ...
        <div class="control-group row-fluid">
            ...
            <div class="tab-content"> <!-- Start TABS -->
                <div id="Lista" class="tab-pane fade active in">
                    ...
                    <table id="ListPaymentmethod" class="table table-hover table-condensed table-striped table-bordered">
                        <thead>
                            <tr>
                                <th><?php echo _('RH') ?></th>
                                <th><?php echo _('Método de pago') ?></th>
                                <th><?php echo _('SAT') ?></th><!--Se agrego satid para el identificador que requiere el SAT Angeles Perez 2016-07-12-->
                                <th><?php echo _('Método de pago SAT') ?></th><!--Se agrego satname para la descripcion que requiere el SAT Angeles Perez 2016-07-12-->
                        ...
                        <tbody>
                            <?php foreach ($PaymentmethodData as $Paymethod){ ?>
                                ...
                                <td><?=$Paymethod['paymentid']?></td>
                                <td><?=$Paymethod['paymentname']?></td>
                                <td><?=$Paymethod['satid']?></td> <!--Se agrego satid para el identificador que requiere el SAT Angeles Perez 2016-07-12-->
                                <td><?=$Paymethod['satname']?></td><!--Se agrego satname para la descripcion del catalogo SAT Angeles Perez 2016-07-12-->
...
<!--Se agrego satname para la descripcion que requiere el SAT Angeles Perez 2016-07-12-->
                        <div class="control-group row-fluid">
                            <div class="span2">
                            ...
                            <div class="span3">
                                <div class="controls">
                                    <input type="text" id="satname" name="satname" />
                                </div>
                            </div>
<!--Termina-->
<!--Se agrego satid para el identificador que requiere el SAT Angeles Perez 2016-07-12-->
                            ...
                            <div class="span3">
                                <div class="controls">
                                    <input type="text" id="satid" name="satid" />
                                </div>
                            </div>
                        </div>
<!--Termina-->
