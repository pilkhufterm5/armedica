            ...
            <table id="RelacionTarjetas" class="table table-striped table-hover table-bordered table-condensed">
                <thead>
                    <tr>
                        ...
                        <th>TIPOCTA</th>
                        <th>CUENTA</th>
                        <th>VENCIMIENTO</th> <!--Se agrego por Angeles Perez 30/03/2016-->
                ...
                <tbody>
                    ...
                    */
                    ...
                    $VENCIMIENTO = Controller::OpenSSLDecrypt($Data['VENCIMIENTO']); //Se agrego por Angeles Perez 30/03/2016
                    $DiaSemana= array(
                        "1"=>"Lunes",
                        "2"=>"Martes",
                        "3"=>"Miercoles",
                    ...
                    <tr <?=$RowColor?> >
                        ...
                        <td><?=$Data['BANCOREC']?></td>
                        <td><?=$Data['TIPOCTA']?></td>
                        <!--SE AGREGO ESPACIOS EN BLANCO PARA CONCIDERAR LA CUENTA COMO UN TEXTO EN EXCEL Angeles Pérez / William Mejia 2015-12-10 -->
                        <td><?=$CUENTA?>&nbsp&nbsp</td> 
                        <td><?=$VENCIMIENTO;?></td> <!--Se agrego por Angeles Perez 30/03/2016-->
