...
/**
 * This is the model class for table "rh_clasificacion_empresas".
 *
 * The followings are the available columns in table 'rh_clasificacion_empresas':
 * @property string $id
...
class Clasificacion extends CActiveRecord
{
	...
	{
		return 'rh_clasificacion_empresas';
	}
