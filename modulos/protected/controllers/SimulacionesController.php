...
class SimulacionesController extends Controller{
	...
	#echo "<pre>"; print_r($_SESSION['UserID']);exit();
	...
	public function actionCreate(){
		...
		foreach($GetAfil as $rows)
		{
			...
			(folio,nombre,apellidos,name2,fecha_ingreso, movimientos_afiliacion,servicios_mes,servicios_acumulados,stockid,paymentid,frecuencia_pago,fecha_ultimo_aumento,costo_actual, prc_aumento_tarifa, fecha_aumento_tarifa,nueva_tarifa,usuario)
